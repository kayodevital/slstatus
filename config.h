...
static const struct arg args[] = {
	...
	//{ run_command,  "Updates: %s |", "apt-get dist-upgrade -s --quiet=2 | grep ^Inst | wc -l"},
	//{ run_command,  "Updates: %s |", "apt-get -s -o Debug::NoLocking=true upgrade | grep ^Inst | wc -l"},
	//{ run_command,  "%s (flatpak) |", "flatpak upgrade | wc -l"},
	...
	//{ battery_perc, "BAT: %s%% |", "BAT1" },
        { datetime,     "%s |",           "%a, %b %d, %R" },
	//{ run_command, "%s", "redshift-gtk -o -P" },
};
